# timezone-portable-unit-tests Specification

## Purpose
Ensure unit tests accurately verify timestamps that are intentionally rendered
in the runtime's local timezone without assuming a particular host timezone.
