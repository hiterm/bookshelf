...
The real-backend integration suite SHALL verify both download paths, filenames,
and their minimum versioned JSON response contract using data created through
normal frontend writes.
