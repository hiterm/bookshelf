...
- [x] 1.1 Commit OpenSpec separately and confirm the HTTP contract

## 2. UI and download behavior

- [x] 2.1 Add the code-split page and Navbar link
- [x] 2.2 Add authenticated Blob download and safe filename handling
- [x] 2.3 Add independent loading and persistent error states
