...
- [ ] 5.1 Run code generation, lint fix, Vitest, typecheck, mock-api E2E, and applicable integration E2E
- [ ] 5.2 Synchronize OpenSpec artifacts with final decisions, mark completed tasks, and pass OpenSpec validation
