...
- [x] 5.4 Push the feature branch, create/update the PR description, and resolve required CI failures
- [x] 5.5 Obtain CodeRabbitAI approval for the latest successful-CI head and resolve all applicable review feedback
